describe "ConnecTag.matchers", () ->
    # All the location matchers are pretty much the same...
    # so I'm just going to test this one because it's easy to manipulate.
    describe "ConnecTag.matchers.hash", () ->
        it "should match patterns against given values or window.location.hash", () ->
            patterns = ['^#yo$', '^#hey$']
    ...
    describe "ConnecTag.matchers.pageId", () ->
        it "should match patterns against given values or ConnecTag.values.pageId", () ->
    ...
    describe "ConnecTag.matchers.event", () ->
        it "should match patterns against given values", () ->
